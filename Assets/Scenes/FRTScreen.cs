...
public class FRTScreen : MonoBehaviour
{
    ...
    string path = @"C:\Users\IMLAB\Desktop\data_reaction\" + ParticipantID + "_" + "data.txt";
    ...
    public void NextTaskSet()
    {
        ...
        currentBox = UnityEngine.Random.Range(1, 5); 
    ...
    {
        if (currentBox == 1 && timer > intervalTime && Input.GetKeyDown("x") ||
            currentBox == 2 && timer > intervalTime && Input.GetKeyDown("c") ||
            currentBox == 3 && timer > intervalTime && Input.GetKeyDown("b") ||
            currentBox == 4 && timer > intervalTime && Input.GetKeyDown("n"))
        {
                //if (!File.Exists(path))
                //{
