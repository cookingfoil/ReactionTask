...
public class TRTScreen : MonoBehaviour
{
    ...
    public void NextTaskSet()
    {
        ...
        currentBox = UnityEngine.Random.Range(1, 3);
    ...
    {
        if (currentBox == 1 && timer > intervalTime && Input.GetKeyDown("c") ||
        currentBox == 2 && timer > intervalTime && Input.GetKeyDown("b"))
